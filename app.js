...
mongoose.connect("mongodb://localhost:27017/finalBlogpost");
...
const Start = mongoose.model("Start", startingSchema);

const startHome = new Start({
  name: "home",
...
// Start.insertMany([startHome, startAbout, startContact], function(err){
//   if(!err){
...
app.get("/", function(req, res){
  res.render("home", {homeContent: homeStartingContent, uploadedPosts: posts});
});
...
app.get("/posts/:topic", function(req, res){
  ...
  for(var i=0; i<posts.length; i++){
    ...
    var iterativePostTitle = _.lowerCase(posts[i].title);

    if(iterativePostTitle === requestedTopic){

       res.render("post", {postTopic: posts[i].title, postBody: posts[i].body});
